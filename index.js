...
let deleteTask = async () => {
    ...
    console.log(chalk.green(`${deletedTask} 👈  this task has been deleted successfully from your To-Do list [for check your list go to option: "view To-Do list"]`));
};
...
let updateTask = async () => {
    ...
    let updatetaskIndex = await inquirer.prompt([
        {
            name: "index",
            type: "number",
            message: chalk.redBright("Enter the 'index no' of the task you want to update :"),
        },
        {
            name: "new_task",
            type: "input",
    ...
    console.log(chalk.green(`Task at index no. ${updatetaskIndex.index - 1} updated successfully your To-Do list [for updated list check option: "view To-Do list"]`));
};
main();
